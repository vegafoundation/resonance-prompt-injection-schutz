...
This repository contains the conceptual definition and theoretical framework for **Prompt-Injection-Schutz**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── prompt-injection-schutz.tex    # LaTeX dissertation
├── whitepaper/
│   └── prompt-injection-schutz.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025promptinjectionschutz,
  author = {Vega, Adam Eren},
  title = {Prompt-Injection-Schutz: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/prompt-injection-schutz}
}
```
